...
# setting SOPC_SYSID_BASE_ADDRESS is 0x810c8
SOPC_SYSID_FLAG += --sidp=0x810c8
ELF_PATCH_FLAG  += --sidp 0x810c8

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1449553603
SOPC_SYSID_FLAG += --timestamp=1449553603
ELF_PATCH_FLAG  += --timestamp 1449553603
