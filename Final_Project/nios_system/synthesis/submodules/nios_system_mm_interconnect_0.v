...
module nios_system_mm_interconnect_0 (
	...
	wire  [94:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> nios2_qsys_0_debug_mem_slave_agent:cp_data
	...
	wire  [16:0] sdram_pll_pll_slave_agent_m0_address;                                               // sdram_pll_pll_slave_agent:m0_address -> sdram_pll_pll_slave_translator:uav_address
	...
	wire  [95:0] sdram_pll_pll_slave_agent_rf_source_data;                                           // sdram_pll_pll_slave_agent:rf_source_data -> sdram_pll_pll_slave_agent_rsp_fifo:in_data
	...
	wire  [95:0] sdram_pll_pll_slave_agent_rsp_fifo_out_data;                                        // sdram_pll_pll_slave_agent_rsp_fifo:out_data -> sdram_pll_pll_slave_agent:rf_sink_data
	...
	wire  [94:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> sdram_pll_pll_slave_agent:cp_data
	...
	wire  [16:0] sprite_num_s1_agent_m0_address;                                                     // sprite_num_s1_agent:m0_address -> sprite_num_s1_translator:uav_address
	...
	wire  [95:0] sprite_num_s1_agent_rf_source_data;                                                 // sprite_num_s1_agent:rf_source_data -> sprite_num_s1_agent_rsp_fifo:in_data
	...
	wire  [95:0] sprite_num_s1_agent_rsp_fifo_out_data;                                              // sprite_num_s1_agent_rsp_fifo:out_data -> sprite_num_s1_agent:rf_sink_data
	...
	wire  [94:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> sprite_num_s1_agent:cp_data
	...
	wire  [16:0] sprite_xy_s1_agent_m0_address;                                                      // sprite_xy_s1_agent:m0_address -> sprite_xy_s1_translator:uav_address
	...
	wire  [95:0] sprite_xy_s1_agent_rf_source_data;                                                  // sprite_xy_s1_agent:rf_source_data -> sprite_xy_s1_agent_rsp_fifo:in_data
	...
	wire  [95:0] sprite_xy_s1_agent_rsp_fifo_out_data;                                               // sprite_xy_s1_agent_rsp_fifo:out_data -> sprite_xy_s1_agent:rf_sink_data
	...
	wire  [94:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> sprite_xy_s1_agent:cp_data
	...
	wire  [16:0] sw_to_hw_s1_agent_m0_address;                                                       // sw_to_hw_s1_agent:m0_address -> sw_to_hw_s1_translator:uav_address
	...
	wire  [95:0] sw_to_hw_s1_agent_rf_source_data;                                                   // sw_to_hw_s1_agent:rf_source_data -> sw_to_hw_s1_agent_rsp_fifo:in_data
	...
	wire  [95:0] sw_to_hw_s1_agent_rsp_fifo_out_data;                                                // sw_to_hw_s1_agent_rsp_fifo:out_data -> sw_to_hw_s1_agent:rf_sink_data
	...
	wire  [94:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> sw_to_hw_s1_agent:cp_data
	...
	wire  [16:0] hw_to_sw_s1_agent_m0_address;                                                       // hw_to_sw_s1_agent:m0_address -> hw_to_sw_s1_translator:uav_address
	...
	wire  [95:0] hw_to_sw_s1_agent_rf_source_data;                                                   // hw_to_sw_s1_agent:rf_source_data -> hw_to_sw_s1_agent_rsp_fifo:in_data
	...
	wire  [95:0] hw_to_sw_s1_agent_rsp_fifo_out_data;                                                // hw_to_sw_s1_agent_rsp_fifo:out_data -> hw_to_sw_s1_agent:rf_sink_data
	...
	wire  [94:0] cmd_mux_008_src_data;                                                               // cmd_mux_008:src_data -> hw_to_sw_s1_agent:cp_data
	...
	wire  [94:0] nios2_qsys_0_debug_mem_slave_agent_rp_data;                                         // nios2_qsys_0_debug_mem_slave_agent:rp_data -> router_004:sink_data
	...
	wire  [94:0] sdram_pll_pll_slave_agent_rp_data;                                                  // sdram_pll_pll_slave_agent:rp_data -> router_005:sink_data
	...
	wire  [94:0] sprite_num_s1_agent_rp_data;                                                        // sprite_num_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [94:0] sprite_xy_s1_agent_rp_data;                                                         // sprite_xy_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [94:0] sw_to_hw_s1_agent_rp_data;                                                          // sw_to_hw_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [94:0] hw_to_sw_s1_agent_rp_data;                                                          // hw_to_sw_s1_agent:rp_data -> router_010:sink_data
